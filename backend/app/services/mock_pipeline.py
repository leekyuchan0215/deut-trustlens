...
def _advance(db: Session, question: Question, stage: str, display_stage: str, percent: int, duration_ms: int) -> None:
...
def _mark_failed(db: Session, question_id: str, error_code: str, error_message: str) -> None:
    ...
    for claim in claims:
        claim_inputs.append(
            ClaimScoreInput(
                ...
                deterministic_verified=claim.verification_basis == "deterministic",
